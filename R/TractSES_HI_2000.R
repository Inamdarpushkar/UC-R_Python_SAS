...
setwd("M:\\LCS_UPDATED\\SES\\Hawaii\\2000\\Tract")
-------------------------------------------------------------------------------------
...
df<-multmerge("M:\\LCS_UPDATED\\SES\\Hawaii\\2000\\Tract")
-------------------------------------------------------------------------------------
...
write.csv(ndf,"M:\\LCS_UPDATED\\SES\\Hawaii\\2000\\TractSES_UpdatedCCR2000.csv" )

--------------------------------------------------------------------------------------
TractSES_UpdatedCCR2000<-read_csv("M:\\LCS_UPDATED\\SES\\Hawaii\\2000\\TractSES_UpdatedCCR2000.csv")
TractSES_UpdatedCCR2000$Q<- CutQ(TractSES_UpdatedCCR2000$Prin1, breaks = quantile(TractSES_UpdatedCCR2000$Prin1, seq(0, 1, by = 0.20), na.rm = TRUE)) 
write.csv(TractSES_UpdatedCCR2000,"M:\\LCS_UPDATED\\SES\\Hawaii\\2000\\TractSES_UpdatedCCR2000.csv" )  
